                ...
                <div className="container-fluid " style={{ background: "white" }}>
                    <div className="mb-2 row ">
                        ...
                        <div className="col-sm-8">
                            ...
                            >
                                <NavBtn
                                    btn_name="Add Question"
                                    icon={<MdAdd size={15} />}
                                    form_path="/quiz/add/question"
                                />
                                {/* Filter Tool */}
                    ...
                    <DataList
                        data_sort={true}
                        Data_Title={QuestionDataTitle}
                        Data_Format={QuestionDataFormat}
                        path={`cards/get_question_details/?search=${search}&p=${page_num}&records=${data_len}`}
                    />
