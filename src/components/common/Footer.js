        ...
        <div className="footer-main">
          ...
          <div className="footer-brand">
            ...
            <p className="brand-description">
              ...
              astronomical shows in our state-of-the-art digital dome theater.
              Explore, learn, and be inspired by the wonders of space.
            </p>
          ...
          <div className="footer-contact">
            ...
            <div className="contact-info">
              <div className="contact-item">
                ...
                <div>
                  <div className="contact-text">Cosmic Vision Planetarium</div>
        ...
        <div className="newsletter-section">
          <div className="newsletter-content">
            <div className="newsletter-text">
              ...
              <p>
                Subscribe to our newsletter for show updates, special offers,
